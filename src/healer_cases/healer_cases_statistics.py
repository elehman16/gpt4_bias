...
def graph_kendalltaus(kendall_tau_df: pd.DataFrame, output_dir: str, case_num: int):
    ...
    # Save it.
    plt.savefig(f'{output_dir}/kendall_tau_case_{case_num}.pdf', bbox_inches='tight')
...
# python src/healer_cases_statistics.py 
...
if __name__ == '__main__':
    ...
    graph_kendalltaus(kendall_tau_df, args.output_dir, args.case_num)
